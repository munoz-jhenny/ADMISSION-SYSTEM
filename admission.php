    ...
    <header>
     ...
     <main class="admission-form">
            ...
            <section class="form-section">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Indicate the amount" required>
                </div>
            </section>
            ...
            <section class="form-section">
                ...
                <div class="upload-group">
                    <label>Valid ID (Photocopy)</label>
                    <input type="file" accept="image/*">
                </div>

                <div class="upload-group">
                    <label>Certificate of Low Income</label>
                    <input type="file" accept="image/*">
                </div>

                <div class="upload-group">
                    <label>Three (3) Specimen Signature</label>
